        ...
        if msg_length:
            ...
            if msg[0:3] == "PUT":
                ...
                for j in receivedData:
                    for keys in j:
                        if (myTrie.search(keys) == False):
                            ...
                            pass
                conn.send("Data uploaded to server 2".encode(FORMAT))
                ...
                if (msg[3] != " "):
                    ...
                    conn.send("NOT FOUND, This data is not in server 2".encode(FORMAT))
                ...
                if Locator == None:
                    conn.send("NOT FOUND, This data is not in server 2, please put in a valid key or path".encode(FORMAT))
                else:
                ...
                if (msg[6] != " "):
                    ...
                    if location is None:
                        ...
                        print(receivedData)
                        conn.send("Data not in server 2".encode(FORMAT))
                    else:
                        receivedData.pop(location)
                        print(receivedData)
                        myTrie.delete(message)
                        conn.send(" ".join([msg[7:len(msg)]+" has been deleted from server 2", ""]).encode(FORMAT))
